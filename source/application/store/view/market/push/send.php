                            ...
                            <div class="am-form-group am-padding-top">
                                ...
                                <div class="am-u-sm-8 am-u-end">
                                    <input type="text" class="tpl-form-input" name="send[page]"
                                           value="pages/index/index" placeholder="请输入公众号页面地址" required>
                                    <small class="am-margin-left-xs">
                                        <span>用户点击消息进入的<a href="<?= url('store/wxapp.page/links') ?>" target="_blank">公众号页面</a>，例如：<code>pages/index/index</code></span>
                                    </small>
                                </div>
                            </div>
