                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[points]" value="">
...
<!--                                        <option value="1" selected>1号商城（报单商城）</option>-->
<!--                                        <option value="2">2号商城（会员商城）</option>-->
<!--                                    </select>-->
<!--                                </div>-->
<!--                            </div>-->
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group points_bei">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[points_times]" value="" required>
