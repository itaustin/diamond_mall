                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">支付积分 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[points]" value="<?= $model['points'] ?>">
                                    <small>选填，积分商城中需要支付的积分。</small>
                                </div>
                            </div>
<!--                            <div class="am-form-group">-->
<!--                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">商城选择 </label>-->
<!--                                <div class="am-u-sm-9 am-u-end">-->
<!--                                    <select name="goods[mall_no]" required-->
<!--                                            data-am-selected="{searchBox: 1, btnSize: 'sm',  placeholder:'请选择商城'}">-->
<!--                                        <option value="">请选择商城</option>-->
<!--                                        <option value="--><?//= $model['mall_no'] ?><!--" --><?//= $model['mall_no'] == 1 ? 'selected' : '' ?><!--1号商城（报单商城）</option>-->
<!--                                        <option value="--><?//= $model['mall_no'] ?><!--" --><?//= $model['mall_no'] == 2 ? 'selected' : '' ?><!--2号商城（会员商城）</option>-->
<!--                                    </select>-->
<!--                                </div>-->
<!--                            </div>-->
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="goods[points_category_id]" required
                                            data-am-selected="{searchBox: 1, btnSize: 'sm',
                                             placeholder:'请选择商品分类', maxHeight: 400}">
                                        <option value=""></option>
                                        <?php if (isset($points_catgory)): foreach ($points_catgory as $first): ?>
                                            <option value="<?= $first['category_id'] ?>"
                                                <?= $model['points_category_id'] == $first['category_id'] ? 'selected' : '' ?>>
                                                <?= $first['name'] ?></option>
                                            <?php if (isset($first['child'])): foreach ($first['child'] as $two): ?>
                                                <option value="<?= $two['category_id'] ?>"
                                                    <?= $model['points_category_id'] == $two['category_id'] ? 'selected' : '' ?>>
                                                    　　<?= $two['name'] ?></option>
                                                <?php if (isset($two['child'])): foreach ($two['child'] as $three): ?>
                                                    <option value="<?= $three['category_id'] ?>"
                                                        <?= $model['points_category_id'] == $three['category_id'] ? 'selected' : '' ?>>
                                                        　　　<?= $three['name'] ?></option>
                                                <?php endforeach; endif; ?>
                                            <?php endforeach; endif; ?>
                                        <?php endforeach; endif; ?>
                                    ...
                                    <small class="am-margin-left-xs">
                                        <a href="<?= url('goods.points_category/add') ?>">去添加</a>
                                    </small>
                                </div>
                            </div>
