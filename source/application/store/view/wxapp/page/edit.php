                    ...
                    <template v-if="diyData.items.length && curItem">
                        ...
                        <div id="tpl_editor_officialAccount" v-if="curItem.type == 'officialAccount'">
                            ...
                            <div class="editor-centent">
                                <p>1、使用组件前，需前往<a href="https://mp.weixin.qq.com" target="_blank">公众号后台</a>，在“设置”->“接口设置”->“公众号关注组件”中设置要展示的公众号。</p>
                                <p class="x-mb-10">注：设置的公众号需与公众号主体一致。</p>
                                <p>2、当公众号从扫二维码场景（场景值1011）打开时，才具有展示引导关注公众号组件的能力。</p>
                            </div>
                        </div>
...
<!--                <div class="pre">-->
<!--                    <p>1. 设计完成后点击"保存页面"，在公众号端页面下拉刷新即可看到效果。</p>-->
