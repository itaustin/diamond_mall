                                    ...
                                    <td class="am-text-middle am-text-left" colspan="6">
                                        <div class="dealer am-cf">
                                            ...
                                            <?php if ($order['second_user_id'] > 0): ?>
                                                <div class="dealer-item am-fl am-margin-right-xl" style="padding-right:25px;border-right:3px dashed #ccc;">
                                                    <p>
                                            ...
                                            <?php if ($order['third_user_id'] > 0): ?>
                                                <div class="dealer-item am-fl am-margin-right-xl" style="border-right:1px solid #ccc;">
                                                    <p>
                                            ...
                                            <?php endif; ?>
                                            <?php if(!empty($order['team_money_resource'])){for ($i = 0; $i < count($order['team_money_resource']); $i ++){?>
                                                <div class="dealer-item am-fl am-margin-right-xl">
                                                    <p>
                                                        <span class="am-text-right">分销商名称：</span>
                                                        <span><?= $order['team_money_resource'][$i]['real_name'] ?>(ID: <?= $order['team_money_resource'][$i]['dealer_id'] ?>)</span>
                                                    </p>
                                                    <p>
                                                        <span class="am-text-right">分销佣金：</span>
                                                        <span class="x-color-red">￥<?= $order['team_money_resource'][$i]['money'] ?></span>
                                                    </p>
                                                </div>
                                            <?php }} ?>
                                        </div>
