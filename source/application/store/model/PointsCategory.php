...
use think\Cache;
use app\common\model\PointsCategory as CategoryModel;
 ...
 */
class PointsCategory extends CategoryModel
{
    /**
     * 添加新记录
     * @param $data
...
//        }
    ...
    {
        // 判断是否存在商品
        if ($goodsCount = (new Goods)->getGoodsTotal([
            'points_category_id' => $categoryId,
        ])) {
    ...
    {
        return Cache::rm('points_category_' . static::$wxapp_id);
    }
