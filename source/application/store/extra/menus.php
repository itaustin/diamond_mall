...
//            [
//                'name' => '申请代理',
//                'index' => 'agent.agent/apply',
//                'uris' => [
//                    'agent.agent/submit',
//                    'agent.agent/confirm_transfer'
//                ]
//            ],
//            [
//                'name' => '分润记录',
//                'index' => 'agent.record/index'
//            ],
//            [
//                'name' => '伙伴分润记录',
//                'index' => 'agent.record/relation'
//            ],
//            [
//                'name' => '自定义区域列表',
//                'index' => 'agent.customarea/index',
//                'uris' => [
//                    'agent.customarea/index',
//                    'agent.customarea/add',
//                    'agent.customarea/edit',
//                    'agent.customarea/delete',
//                ]
//            ],
//            [
//                'name' => '提现管理',
//                'index' => 'agent.withdraw/index',
//                'uris' => [
//                    'agent.withdraw/index',
//                    'agent.withdraw/apply',
//                    'agent.withdraw/submit',
//                    'agent.withdraw/money',
//                    'agent.withdraw/wechat_pay'
//                ]
//            ],
//            [
//                'name' => '密码修改',
//                'index' => 'store.user/renew'
//            ]
//        ]
//    ],
    'store' => [
    ...
    'goods' => [
        ...
        'submenu' => [
            ...
            [
                'name' => '积分商品分类',
                'index' => 'goods.points_category/index',
                'uris' => [
                    'goods.points_category/index',
                    'goods.points_category/add',
                    'goods.points_category/edit',
                ],
            ],
            [
                'name' => '商品评价',
