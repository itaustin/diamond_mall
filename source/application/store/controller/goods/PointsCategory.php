...
use app\store\model\PointsCategory as CategoryModel;
...
class PointsCategory extends Controller
{
    ...
    public function add()
    {
        ...
        if ($model->add($this->postData('category'))) {
            return $this->renderSuccess('添加成功', url('goods.points_category/index'));
        }
    ...
    public function edit($category_id)
    {
        ...
        if ($model->edit($this->postData('category'))) {
            return $this->renderSuccess('更新成功', url('goods.points_category/index'));
        }
